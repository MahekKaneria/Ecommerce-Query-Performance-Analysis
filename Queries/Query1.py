...
base_directory = os.path.join(os.path.dirname(__file__), '../Databases')
...
# Connect to all 3 database and execute Query 1 50 times for each scenario
...
plt.savefig(os.path.join(graphs_directory, "Query 1 graph.png"))
#################################################################################
